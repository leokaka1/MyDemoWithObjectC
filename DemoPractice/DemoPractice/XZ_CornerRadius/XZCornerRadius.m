...
/////////////////////////////////////////////////////////////////////
@interface XZImageObserver : NSObject
...
@implementation XZImageObserver
...
- (XZImageObserver *)imageObserver {
    XZImageObserver *imageObserver = objc_getAssociatedObject(self, @selector(imageObserver));
    if (!imageObserver) {
        imageObserver = [[XZImageObserver alloc] initWithImageView:self];
