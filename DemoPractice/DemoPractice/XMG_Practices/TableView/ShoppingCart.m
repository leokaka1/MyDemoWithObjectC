...
//    添加subViews
    ...
    bottomTitleLabel.frame = CGRectMake(10, 15, 100, 20);
    ...
    _itemCountLabel.frame = CGRectMake(120, 15, 50, 20);
    [bottomTotalView addSubview:_itemCountLabel];
    
//    总金额
    _totalPriceLabel = [[UILabel alloc]initWithFrame:CGRectMake(180, 15, 50, 20)];
